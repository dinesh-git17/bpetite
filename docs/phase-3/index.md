...
- Three area docs (`encode-decode`, `public-api`, `roundtrip-suite`) cover
  separate areas; this index is the entry point and the single place where new
...
1. **[Encode and Decode](encode-decode.md):** Read the encode
