...
Every decision &mdash; how pairs are counted, how ties break, how merges apply, how the encoder walks a chunk &mdash; lives in readable Python. No C extensions, no Rust, no external tokenizer library. One runtime dependency beyond the standard library: `regex`, used exclusively for the GPT-2 pre-tokenizer pattern.
